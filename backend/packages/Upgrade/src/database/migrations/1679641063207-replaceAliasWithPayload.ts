...
export class replaceAliasWithPayload1679641063207 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "public"."level" ADD "payloadType" "public"."level_payload_type_enum" NOT NULL DEFAULT 'string'`);
        ...
        await queryRunner.query(`ALTER TABLE "public"."condition_payload" ADD "payloadType" "public"."condition_payload_type_enum" NOT NULL DEFAULT 'string'`);
    }
