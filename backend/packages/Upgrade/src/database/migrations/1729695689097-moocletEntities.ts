...
export class MoocletEntities1729695689097 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "mooclet_experiment_ref" ADD CONSTRAINT "FK_df88beb64b5be102b4637ef3756" FOREIGN KEY ("experimentId") REFERENCES "experiment"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
