...
export class AddMoocletExperimentRef1727741198100 implements MigrationInterface {
    name = 'AddMoocletExperimentRef1727741198100'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "mooclet_version_condition_map" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "moocletVersionId" integer NOT NULL, "upgradeConditionId" character varying NOT NULL, "moocletExperimentRefId" uuid NOT NULL, CONSTRAINT "PK_0723d7ad1cdc035f4adb5281727" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "mooclet_experiment_ref" ("id" uuid NOT NULL, "moocletId" integer NOT NULL, "policyParametersId" integer, "variableId" integer, CONSTRAINT "PK_4b09b92ba15f54e38b226a442c6" PRIMARY KEY ("id"))`);
