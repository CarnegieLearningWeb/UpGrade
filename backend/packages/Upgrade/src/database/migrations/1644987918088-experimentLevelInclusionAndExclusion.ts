...
export class experimentLevelInclusionAndExclusion1644987918088 implements MigrationInterface {
    name = 'experimentLevelInclusionAndExclusion1644987918088'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "experiment" ADD "filterMode" "public"."experiment_filtermode_enum" NOT NULL`);
