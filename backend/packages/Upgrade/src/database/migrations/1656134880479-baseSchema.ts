...
export class baseSchema1656134880479 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "query" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "versionNumber" integer NOT NULL, "id" uuid NOT NULL, "name" text NOT NULL, "query" jsonb NOT NULL, "repeatedMeasure" "query_repeatedmeasure_enum" NOT NULL DEFAULT 'MOST RECENT', "metricKey" character varying, "experimentId" uuid, CONSTRAINT "PK_be23114e9d505264e2fdd227537" PRIMARY KEY ("id"))`);
