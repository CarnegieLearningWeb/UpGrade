...
export class baseSchema1656134880479 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "decision_point" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "versionNumber" integer NOT NULL, "id" character varying NOT NULL, "twoCharacterId" character(2) NOT NULL, "site" character varying NOT NULL, "target" character varying, "description" character varying NOT NULL, "order" integer, "experimentId" uuid, CONSTRAINT "UQ_99875dcd62e9df24745809953f2" UNIQUE ("twoCharacterId"), CONSTRAINT "PK_e55e73f039848e3a1cac0e491bb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "monitored_decision_point_log" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "versionNumber" integer NOT NULL, "id" SERIAL NOT NULL, "monitoredDecisionPointId" character varying, CONSTRAINT "PK_2fa4825c93a748b4e62553a46fe" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "monitored_decision_point" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "versionNumber" integer NOT NULL, "id" character varying NOT NULL, "decisionPoint" character varying NOT NULL, "condition" character varying, "userId" character varying, CONSTRAINT "PK_7fd52382a1b12f6d55ec2cc674d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_c2bb5acceb92a29fd022c5ff30" ON "monitored_decision_point" ("decisionPoint") `);
