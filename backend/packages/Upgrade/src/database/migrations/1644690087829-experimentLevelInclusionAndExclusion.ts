...
export class experimentLevelInclusionAndExclusion1644689590414 implements MigrationInterface {
  public name = 'experimentLevelInclusionAndExclusion1644689590414'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
	  	`CREATE TABLE "explicit_experiment_individual_inclusion" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "versionNumber" integer NOT NULL, "userId" character varying NOT NULL, "experimentId" uuid NOT NULL, CONSTRAINT "PK_757b62cf84e8ffd940f47d0a919" PRIMARY KEY ("userId", "experimentId"))`
	  );
    await queryRunner.query(
	  	`ALTER TABLE "explicit_experiment_group_exclusion" ADD CONSTRAINT "FK_2b27448c9c812f4b8034b9d9a83" FOREIGN KEY ("experimentId") REFERENCES "experiment"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(
	  	`ALTER TABLE "explicit_experiment_group_inclusion" ADD CONSTRAINT "FK_715783397ec4bc97b1f66a3e804" FOREIGN KEY ("experimentId") REFERENCES "experiment"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(
	  	`ALTER TABLE "explicit_experiment_individual_exclusion" ADD CONSTRAINT "FK_f6ad55b6af879555d3d8f0df5b8" FOREIGN KEY ("experimentId") REFERENCES "experiment"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    await queryRunner.query(
	  	`ALTER TABLE "explicit_experiment_individual_inclusion" ADD CONSTRAINT "FK_00a1d27140e6f49db66b3acccfc" FOREIGN KEY ("experimentId") REFERENCES "experiment"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
  }
