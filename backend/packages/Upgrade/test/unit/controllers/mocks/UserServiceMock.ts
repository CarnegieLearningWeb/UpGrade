...
import { IUserSearchParams, IUserSortParams } from '../../../../src/api/controllers/validators/UserPaginatedParamsValidator';
...
export default class UserServiceMock {
    ...
    public findPaginated(skip: number, take: number, logger: UpgradeLogger, searchParams?: IUserSearchParams, sortParams?: IUserSortParams
      ): Promise<[]> {
          return Promise.resolve([])
      }
