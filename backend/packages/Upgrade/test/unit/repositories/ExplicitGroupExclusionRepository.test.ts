...
describe('ExplicitGroupExclusionRepository Testing', () => {
    ...
    it('should insert a new group experiment exclusion', async () => {
        createQueryBuilderStub = sandbox.stub(ExplicitGroupExclusionRepository.prototype, 
            'createQueryBuilder').withArgs('explicitGroupExclusion').returns(insertQueryBuilder);
        const result =  {
    ...
    it('should throw an error when insert fails', async () => {
        ...
        expect(async() => {await repo.saveRawJson(groupExclude)}).rejects.toThrow(err);
    ...
    it('should throw an error when delete fails', async () => {
        ...
        expect(async() => {await repo.deleteGroup(groupExclude.groupId, groupExclude.type)}).rejects.toThrow(err);
