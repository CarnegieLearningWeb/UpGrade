...
let insertQueryBuilder = new InsertQueryBuilder<ExperimentSegmentExclusionRepository>(null);
let deleteQueryBuilder = new DeleteQueryBuilder<ExperimentSegmentExclusionRepository>(null);
let selectQueryBuilder = new SelectQueryBuilder<ExperimentSegmentExclusionRepository>(null);
let repo = new ExperimentSegmentExclusionRepository();
...
describe('ExperimentSegmentExclusionRepository Testing', () => {
    ...
    it('should throw an error when insert fails', async () => {
        ...
        expect(async() => {await repo.insertData(segment, logger, manager)}).rejects.toThrow(err);
    ...
    it('should delete a segment exclusion', async () => {
        createQueryBuilderStub = sandbox.stub(ExperimentSegmentExclusionRepository.prototype, 
    ...
    it('should throw an error when delete fails', async () => {
        ...
        expect(async() => {await repo.deleteData(segment.id, 'exp1', logger)}).rejects.toThrow(err);
    ...
    it('should get a segment exclusion', async () => {
        ...
        let res = await repo.getExperimentSegmentExclusionData();
    ...
    it('should throw an error when get segment exclusion fails', async () => {
        ...
        expect(async() => {await repo.getExperimentSegmentExclusionData()}).rejects.toThrow(err);
