import { Connection, ConnectionManager, DeleteQueryBuilder, EntityManager, InsertQueryBuilder, SelectQueryBuilder, UpdateQueryBuilder } from "typeorm";
...
describe('ExperimentRepository Testing', () => {
    ...
    it('should throw an error when insert fails', async () => {
        ...
        expect(async() => {await repo.insertExperiment(experiment, manager)}).rejects.toThrow(err);
    ...
    it('should throw an error when insert batch fails', async () => {
        ...
        expect(async() => {await repo.insertBatchExps([experiment], manager)}).rejects.toThrow(err);
    ...
    it('should throw an error when delete fails', async () => {
        ...
        expect(async() => {await repo.deleteById(experiment.id, manager)}).rejects.toThrow(err);
    ...
    it('should find all experiments', async () => {
        createQueryBuilderStub = sandbox.stub(ExperimentRepository.prototype, 
        ...
        selectMock.expects('leftJoinAndSelect').exactly(15).returns(selectQueryBuilder);
    ...
    it('should throw an error when find all experiments fails', async () => {
        ...
        expect(async() => {await repo.findAllExperiments()}).rejects.toThrow(err);
    ...
    it('should throw an error find all experiments by name fails', async () => {
        ...
        expect(async() => {await repo.findAllName()}).rejects.toThrow(err);
    ...
    it('should get valid experiments', async () => {
        ...
        selectMock.expects('leftJoinAndSelect').exactly(14).returns(selectQueryBuilder);
    ...
    it('should throw an error get valid experiments fails', async () => {
        ...
        expect(async() => {await repo.getValidExperiments('context')}).rejects.toThrow(err);
    ...
    it('should throw an error get valid experiments with preview fails', async () => {
        ...
        expect(async() => {await repo.getValidExperimentsWithPreview('context')}).rejects.toThrow(err);
    ...
    it('should throw an error when update state fails', async () => {
        ...
        expect(async() => {await repo.updateState(experiment.id, EXPERIMENT_STATE.ENROLLING, new Date('1-19-2022'))}).rejects.toThrow(err);
    ...
    it('should throw an error when update state with manager fails', async () => {
        ...
        expect(async() => {await repo.updateState(experiment.id, EXPERIMENT_STATE.ENROLLING, new Date('1-19-2022'), manager)}).rejects.toThrow(err);
    ...
    it('should throw an error when update experiment fails', async () => {
        ...
        expect(async() => {await repo.updateExperiment(experiment, manager)}).rejects.toThrow(err);
    ...
    it('should throw an error when clear the database fails', async () => {
        ...
        expect(async() => {await repo.clearDB(manager, new UpgradeLogger())}).rejects.toThrow('DB truncate error. DB truncate unsuccessful');
    });
