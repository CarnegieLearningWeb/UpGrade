...
describe('ExperimentSegmentInclusionRepository Testing', () => {
    ...
    it('should delete a segment inclusion', async () => {
        createQueryBuilderStub = sandbox.stub(ExperimentSegmentInclusionRepository.prototype, 
    ...
    it('should throw an error when get segment inclusion fails', async () => {
        ...
        expect(async() => {await repo.getExperimentSegmentInclusionData()}).rejects.toThrow(err);
