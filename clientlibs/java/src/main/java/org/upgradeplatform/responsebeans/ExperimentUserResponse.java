...
public class ExperimentUserResponse {
	...
	public ExperimentUserResponse() {
	}

	public ExperimentUserResponse(String id, Map<String, List<String>> group, Map<String, String> workingGroup,
