...
;// CONCATENATED MODULE: ./src/demo.test.ts
 ...
 */
var executeUserTasks = function executeUserTasks() {
  var res = http_default().get('https://httpbin.test.k6.io/');
...
/* harmony default export */ const demo_test = (executeUserTasks);
