...
if (!lambdaPath.endsWith('/')) { lambdaPath += '/'; }
...
.catch(error => {
    console.log(JSON.stringify({"error": "1", "error": error.toString(), "output_path": outputPath, lambdaPath: lambdaPath, __dirname: __dirname}))
});
