...
describe('ExperimentActionMessage', () => {
  ...
  it('should return translation string of EXPERIMENT_CREATED', () => {
    expect(experimentActionMessagePipe.transform(EXPERIMENT_LOG_TYPE.EXPERIMENT_CREATED)).toBe('logs.audit-log-experiment-created.text');
  });

  it('should return translation string of EXPERIMENT_DELETED', () => {
    expect(experimentActionMessagePipe.transform(EXPERIMENT_LOG_TYPE.EXPERIMENT_DELETED)).toBe('logs.audit-log-experiment-deleted.text');
  });

  it('should return translation string of EXPERIMENT_STATE_CHANGED', () => {
    expect(experimentActionMessagePipe.transform(EXPERIMENT_LOG_TYPE.EXPERIMENT_STATE_CHANGED)).toBe('logs.audit-log-experiment-state-changed.text');
  });
