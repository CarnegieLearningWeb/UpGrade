...
export class AnalyticsRepository extends Repository<AnalyticsRepository> {
  ...
  public async getEnrollmentByDateRange(
    ...
    const { whereDate: individualWhereDate, selectRange: individualSelectRange } = getDateVariables(
      dateRange,
      clientOffset,
    ...
    const { whereDate: groupWhereDate, selectRange: groupSelectRange } = getDateVariables(
      dateRange,
      clientOffset,
      'groupEnrollment'
    );
