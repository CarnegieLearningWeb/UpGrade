...
export default async function GroupUserCount(): Promise<void> {
  ...
  markedExperimentPoint = await markExperimentPoint(experimentUsers[4].id, experimentName, experimentPoint);
  ...
  markedExperimentPoint = await markExperimentPoint(experimentUsers[5].id, experimentName, experimentPoint);
