...
//	public static String studentId = "";
	...
	public final String INVALID_INIT_USER_DATA = "Invalid user init data";
	public final String INVALID_GROUP_MEMBERSHIP_DATA = "Invalid user group data";
	public final String INVALID_WORKING_GROUP_DATA = "Invalid user working group data";
	public final String INVALID_STUDENT_ID = "Invalid student id. It must be valid string";
	public final String INVALID_MARK_EXPERIMENT_DATA = "Invalid mark experiment data";
	public final String INVALID_FAILED_EXPERIMENT_DATA = "Invalid failed experiment data";
