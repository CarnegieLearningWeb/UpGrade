...
console.log(`Beginning pre build environment string replacements in environments.${environment}.ts files`);
for (var i in replacements) {
  try {
    const changedFiles = replace.sync({
      files: [`projects/upgrade/src/environments/environment.${environment}.ts`],
