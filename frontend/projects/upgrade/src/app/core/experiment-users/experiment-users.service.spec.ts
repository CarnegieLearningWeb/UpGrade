...
import { actionDeleteExcludedGroup, actionDeleteExcludedUser, actionExcludeGroup, actionExcludeUser, actionFetchExcludedGroups, actionFetchExcludedUsers } from './store/experiment-users.actions';
...
describe('ExperimentUsersService', () => {
    ...
    describe('#deleteExcludedGroup', () => {
        it('should dispatch actionLoginStart', () => {
            ...
            expect(mockStore.dispatch).toHaveBeenCalledWith(actionDeleteExcludedGroup({
                id: mockId,
                groupType: mockGroupType
            }));
        })
