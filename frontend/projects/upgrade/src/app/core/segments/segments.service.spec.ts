...
describe('SegmentService', () => {
    ...
    // let mockFeatureFlagsList: Segment[] = [
    //     {
    ...
    // //         SegmentSelectors.selectAllFeatureFlags.setResult([ ...mockFeatureFlagsList ]);
    ...
    //         expect(mockStore.dispatch).toHaveBeenCalledWith(FeatureFlagsActions.actionFetchFeatureFlags({ fromStarting: undefined }))
    //     })
    // })
    ...
    //         expect(mockStore.dispatch).toHaveBeenCalledWith(FeatureFlagsActions.actionUpsertFeatureFlag({ flag, actionType: UpsertFeatureFlagType.CREATE_NEW_FLAG }));
    //     })
    // })
    ...
    //         expect(mockStore.dispatch).toHaveBeenCalledWith(FeatureFlagsActions.actionUpsertFeatureFlag({ flag, actionType: UpsertFeatureFlagType.UPDATE_FLAG }));
    //     })
    // })
