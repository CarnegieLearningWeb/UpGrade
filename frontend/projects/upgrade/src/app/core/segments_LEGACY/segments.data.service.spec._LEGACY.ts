...
describe('SegmentDataService_LEGACY', () => {
  let mockHttpClient: any;
  let service: SegmentsDataService_LEGACY;
  let mockSegmentInput: SegmentInput_LEGACY;
  let mockSegmentId: string;
  let mockEnvironment: Environment;
  let mockSegmentFile: SegmentFile_LEGACY;

  beforeEach(() => {
    mockHttpClient = new MockHTTPClient();
    mockEnvironment = { ...environment };
    service = new SegmentsDataService_LEGACY(mockHttpClient as HttpClient, mockEnvironment);
