...
import { Segment_LEGACY, SegmentFile_LEGACY, importError_LEGACY } from '../../../../../../core/segments_LEGACY/store/segments.model._LEGACY';
import { MatTableDataSource } from '@angular/material/table';
import { TranslateService } from '@ngx-translate/core';
import { SegmentsDataService_LEGACY } from '../../../../../../core/segments_LEGACY/segments.data.service._LEGACY';
...
export class ImportSegmentComponent {
  ...
  fileData: SegmentFile_LEGACY[] = [];
  nonErrorSegments: number;
  importFileErrorsDataSource = new MatTableDataSource<importError_LEGACY>();
  importFileErrors: importError_LEGACY[] = [];
  ...
  constructor(
    ...
    private segmentDataService: SegmentsDataService_LEGACY,
  ...
  async validateFiles() {
    this.importFileErrors =
      ((await this.segmentDataService.validateSegments(this.fileData).toPromise()) as importError_LEGACY[]) || [];
