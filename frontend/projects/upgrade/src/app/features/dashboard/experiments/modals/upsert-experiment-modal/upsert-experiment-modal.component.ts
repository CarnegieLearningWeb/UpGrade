...
export class UpsertExperimentModalComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    const moocletAlgorithmOptions = this.moocletHelperService.getSupportedMoocletAlgorithmOptions();
  ...
  checkForMoocletAlgorithmChange(): void {
    ...
    if (!this.moocletHelperService.isMoocletAlgorithm(this.assignmentAlgorithmValue)) {
