  ...
  ngOnInit(): void {
    ...
    this.menuButtonItems$ = this.flagAndPermissions$.pipe(
      map(({ flag, permissions }) => [
        { name: FEATURE_FLAG_DETAILS_PAGE_ACTIONS.EDIT, action: 'fix', disabled: !permissions.featureFlags.update },
        { name: FEATURE_FLAG_DETAILS_PAGE_ACTIONS.DUPLICATE, action: 'fix', disabled: !permissions.featureFlags.create },
        { name: FEATURE_FLAG_DETAILS_PAGE_ACTIONS.EXPORT_DESIGN, action: 'fix', disabled: false },
        { name: FEATURE_FLAG_DETAILS_PAGE_ACTIONS.EMAIL_DATA, action: 'fix', disabled: true },
        { name: FEATURE_FLAG_DETAILS_PAGE_ACTIONS.ARCHIVE, action: 'fix', disabled: true },
        {
          name: FEATURE_FLAG_DETAILS_PAGE_ACTIONS.DELETE, action: 'fix', 
