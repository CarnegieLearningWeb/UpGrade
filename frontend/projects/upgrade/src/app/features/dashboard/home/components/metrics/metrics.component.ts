...
export class MonitoredMetricsComponent implements OnInit, OnChanges, OnDestroy {
  ...
  ngOnInit() {
    // TODO: Remove the global metric rows whenever the unit of assignment has been changed from Individual/Group to Within-subjects?
  ...
  get CategoricalRepeatedMeasure() {
    const repeatedMeasure = Object.values(REPEATED_MEASURE);
    return repeatedMeasure.slice(1);
  }
