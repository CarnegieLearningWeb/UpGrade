...
@Component({
  selector: 'app-import-segment-modal',
  imports: [
    CommonModalComponent,
    CommonModule,
    SharedModule,
  ...
  templateUrl: './import-segment-modal.component.html',
  styleUrls: ['./import-segment-modal.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ImportSegmentModalComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ImportSegmentModalComponent>,
