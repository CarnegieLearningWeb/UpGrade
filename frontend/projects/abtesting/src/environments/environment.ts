...
// const endpointApi = 'https://development-upgrade-experiment-app.eba-gp6psjut.us-east-1.elasticbeanstalk.com/api';
const endpointApi = 'https://upgrade-dev-backend.edoptimize.com/api'
